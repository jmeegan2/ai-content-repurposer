  ...
  function renderUploadSection() {
    ...
    if (uploadStatus === "uploaded" && clip.youtubeVideoId) {
      return (
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="mt-auto flex items-center justify-center gap-2 bg-green-700 hover:bg-green-600 text-white text-sm font-medium px-4 py-2 rounded-lg transition-colors"
        >
    ...
    return (
      <button
        ...
        className="mt-1 flex items-center justify-center gap-2 bg-red-600 hover:bg-red-500 disabled:opacity-60 text-white text-sm font-medium px-4 py-2 rounded-lg transition-colors w-full"
      >
        {uiState === "checking" ? (
          <>
            <svg className="w-4 h-4 animate-spin" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}>
        ...
        <div className="p-4 flex flex-col gap-3 flex-1">
          ...
          {clip.s3Url ? (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="bg-white hover:bg-zinc-100 text-black text-sm font-medium px-4 py-2 rounded-lg transition-colors text-center"
            >
              Download MP4
            </a>
          ) : (

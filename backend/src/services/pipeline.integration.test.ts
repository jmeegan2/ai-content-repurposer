...
describe('pipeline integration', () => {
  ...
  const TEST_URL = 'https://www.youtube.com/watch?v=d6wRkzCW5qI';

  it('runs all stages end-to-end and lands on done with clips', async () => {
    ...
    console.log('Detected clips:', JSON.stringify(clipsPatch?.clips, null, 2));

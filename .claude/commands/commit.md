...
3. Check if there is an open PR on this branch (`gh pr list --head <branch>`). If one exists, ask the user:
   "Do you want to update the DEVLOG for this commit?"
4. Write a concise commit message: one short subject line describing _what changed and why_. Use the  
   HEREDOC format.
5. Create the commit, then push to the current branch.
